            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                       ...
                       <!--           <a href="cart.php" class="add_to_cart_button"><i class="fa fa-shopping-cart"></i> Add to cart</a> -->

                                  <?php
                                      echo'<a href="add_cart.php?nm='. $row['name'].'&mrp='.$row['price'].'&img='.$row['image'].'" class="add_to_cart_button">Add To Cart</a>';
                                    ?>
                            </form>
                                    <?php } ?>
                                </div>
